const getSearchValue = () =>{
    ...
    fetch(`http://openlibrary.org/search.json?q=${inputField}`)
    .then(res => res.json())
      ...
      bookData.forEach(book => {
        ...
        // //   console.log(url);
          let responsePart = document.getElementById('response-part');
            ...
            <img src="http://covers.openlibrary.org/b/id/${book.cover_i}-L.jpg" class="card-img-top " style="height:300px" alt="...">
            <div class="card-body">
